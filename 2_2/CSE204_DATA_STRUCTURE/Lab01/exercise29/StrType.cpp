...
{
	// using strcmp
	// return strcmp(letters, otherString.letters);

	for (size_t charIndex = 0; charIndex < MAX_CHARS + 1; ++charIndex)
	{
		if (letters[charIndex] == '\0' && otherString.letters[charIndex] != '\0')
		{
			return LESS;
		}
		else if (letters[charIndex] != '\0' && otherString.letters[charIndex] == '\0')
		{
			return GREATER;
		}
		else if (letters[charIndex] == '\0' && otherString.letters[charIndex] == '\0')
		...
		if (letters[charIndex] < otherString.letters[charIndex])
		{
			return LESS;	// otherString is bigger than letter
		}
		else if (letters[charIndex] > otherString.letters[charIndex])
		{
			return GREATER;	// letter is bigger than letter
		}
	}
